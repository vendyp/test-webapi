...
{
    [JsonPropertyName("coord")] public Coord Coord { get; set; } = null!;

    [JsonPropertyName("weather")] public List<Weather> Weather { get; set; } = new List<Weather>();
    ...
    [JsonPropertyName("wind")] public Wind Wind { get; set; } = null!;

    [JsonPropertyName("rain")] public Rain Rain { get; set; } = null!;

    [JsonPropertyName("clouds")] public Clouds Clouds { get; set; } = null!;

    [JsonPropertyName("dt")] public int? Dt { get; set; }

    [JsonPropertyName("sys")] public Sys Sys { get; set; } = null!;
